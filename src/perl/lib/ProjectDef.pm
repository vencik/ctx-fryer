...
sub new($@) {
    ...
    my $metainfo  = ($skip_metainfo  ? undef : new ProjectDef::MetaInfo);
    my $terminals = ($skip_grammar   ? undef : new ProjectDef::Grammar::TerminalSymbols);
    my $rules     = ($skip_grammar   ? undef : new ProjectDef::Grammar::Rules);
    my $attrs     = ($skip_grammar   ? undef : new ProjectDef::Grammar::Attributes);
    my $unit_test = ($skip_unit_test ? undef : new ProjectDef::UnitTest);
